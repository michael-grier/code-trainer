...
export function TwoPointersDiagram() {
  const arrowId = useDiagramArrowId('two-pointers-arrow')
...
export function StackDiagram() {
  const arrowId = useDiagramArrowId('stack-arrow')
...
export function QueueDequeDiagram() {
  const arrowId = useDiagramArrowId('queue-arrow')
...
export function LinkedListDiagram() {
  const arrowId = useDiagramArrowId('linked-list-arrow')
...
export function GraphDiagram() {
  const arrowId = useDiagramArrowId('graph-arrow')
...
export function WeightedGraphDiagram() {
  const arrowId = useDiagramArrowId('weighted-graph-arrow')
...
export function DynamicProgrammingDiagram() {
  const arrowId = useDiagramArrowId('dynamic-programming-arrow')
...
export function AdvancedDynamicProgrammingDiagram() {
  const arrowId = useDiagramArrowId('advanced-dynamic-programming-arrow')
  const values = [
    ['1', '4', '5'],
    ['2', '7', '6'],
    ['6', '8', '7'],
